...
namespace TabularEditor.TOMWrapper
{
    internal static partial class Properties
    {
	    ...
	    public const string CALENDARCOLUMNGROUPS = "CalendarColumnGroups";
	...
	internal static class ObjectMetadata
	{
		...
		private static readonly Dictionary<Type, Type> TOMMap = new Dictionary<Type, Type>() {
            ...
            { typeof(CalendarColumnGroup) , typeof(TOM.CalendarColumnGroup) },
            { typeof(TimeUnitColumnAssociation) , typeof(TOM.TimeUnitColumnAssociation) },
            { typeof(TimeRelatedColumnGroup) , typeof(TOM.TimeRelatedColumnGroup) },
...
/// </summary><remarks>This metadata object is only supported when the compatibility level of the database is at 1701 or above.</remarks>
	[TypeConverter(typeof(DynamicPropertyConverter))]
	public abstract partial class CalendarColumnGroup: TabularObject
	{
	    internal new TOM.CalendarColumnGroup MetadataObject 
		{ 
			get 
			{ 
				return base.MetadataObject as TOM.CalendarColumnGroup; 
		    } 
			set 
			{ 
				base.MetadataObject = value; 
...
///             </summary>
		...
		[Category("Options"),Description(@"A reference to a Calendar object that owns this CalendarColumnGroup."),IntelliSense(@"A reference to a Calendar object that owns this CalendarColumnGroup.")][Browsable(false)]
		public Calendar Calendar {
			get {
				if (MetadataObject.Calendar == null) return null;
			    return Handler.WrapperLookup[MetadataObject.Calendar] as Calendar;
            }
			
		}
		private bool ShouldSerializeCalendar() { return false; }
        ...
        internal override void RenewMetadataObject()
        {
            Handler.WrapperLookup.Remove(MetadataObject);
            var json = TOM.JsonSerializer.SerializeObject(MetadataObject, RenewMetadataOptions, Handler.CompatibilityLevel, Handler.Database.CompatibilityMode);
            MetadataObject = TOM.JsonSerializer.DeserializeObject<TOM.CalendarColumnGroup>(json);
            Handler.WrapperLookup.Add(MetadataObject, this);
        }

		///<summary>The parent Calendar of the current Calendar Column Group.</summary>
		public Calendar Parent { 
			get {
				return Handler.WrapperLookup[MetadataObject.Parent] as Calendar;
			}
		}
		...
		/// CTOR - only called from static factory methods on the class
		/// </summary>
		protected CalendarColumnGroup(TOM.CalendarColumnGroup metadataObject) : base(metadataObject)
		{
		}
	...
	/// </summary>
	public sealed partial class CalendarColumnGroupCollection: TabularObjectCollection<CalendarColumnGroup>
	{
		internal Calendar Calendar { get { return Parent as Calendar; } }
		TOM.CalendarColumnGroupCollection TOM_Collection;
		internal CalendarColumnGroupCollection(string collectionName, TOM.CalendarColumnGroupCollection metadataObjectCollection, Calendar parent) : base(collectionName, parent)
		{
			TOM_Collection = metadataObjectCollection;
		}
		internal override Type GetItemType() { return typeof(CalendarColumnGroup); }
        internal override void TOM_Add(TOM.MetadataObject obj) { TOM_Collection.Add(obj as TOM.CalendarColumnGroup); }
        internal override bool TOM_Contains(TOM.MetadataObject obj) { return TOM_Collection.Contains(obj as TOM.CalendarColumnGroup); }
        internal override void TOM_Remove(TOM.MetadataObject obj) { TOM_Collection.Remove(obj as TOM.CalendarColumnGroup); }
        internal override void TOM_Clear() { TOM_Collection.Clear(); }
		internal override TOM.MetadataObject TOM_Get(int index) { return TOM_Collection[index]; }
        internal override int IndexOf(TOM.MetadataObject obj) { return TOM_Collection.IndexOf(obj as TOM.CalendarColumnGroup); }
        /// <summary>The number of items in this collection.</summary>
		public override int Count { get { return TOM_Collection.Count; } }
		/// <summary>Returns an enumerator that iterates through the collection.</summary>
        public override IEnumerator<CalendarColumnGroup> GetEnumerator() { return TOM_Collection.Select(h => Handler.WrapperLookup[h]).OfType<CalendarColumnGroup>().GetEnumerator(); }
		internal override void Reinit() {
			var ixOffset = 0;
			for(int i = 0; i < Count; i++) {
				var metadataObj = TOM_Get(i) as TOM.CalendarColumnGroup;
				var item = Handler.WrapperLookup.TryGetValue(metadataObj, out var existingItem) ? existingItem as CalendarColumnGroup : CreateFromMetadata(metadataObj);
				Handler.WrapperLookup.Remove(item.MetadataObject);
				item.MetadataObject = Calendar.MetadataObject.CalendarColumnGroups[i + ixOffset] as TOM.CalendarColumnGroup;
				Handler.WrapperLookup.Add(item.MetadataObject, item);
				item.Collection = this;
			}
			TOM_Collection = Calendar.MetadataObject.CalendarColumnGroups;
			foreach(var item in this) item.Reinit();
		}
		...
		private CalendarColumnGroup CreateFromMetadata(TOM.CalendarColumnGroup obj)
		{
			if(obj is TOM.TimeRelatedColumnGroup timerelatedcolumngroupObj) return TimeRelatedColumnGroup.CreateFromMetadata(Calendar, timerelatedcolumngroupObj);
			if(obj is TOM.TimeUnitColumnAssociation timeunitcolumnassociationObj) return TimeUnitColumnAssociation.CreateFromMetadata(Calendar, timeunitcolumnassociationObj);
            else throw new ArgumentException("Cannot create object", "obj");
		}

		/// <summary>
		/// Calling this method will populate the CalendarColumnGroupCollection with objects based on the MetadataObjects in the corresponding MetadataObjectCollection.
		/// </summary>
		internal override void CreateChildrenFromMetadata()
		{
			// Construct child objects (they are automatically added to the Handler's WrapperLookup dictionary):
...
/// </summary><remarks>This metadata object is only supported when the compatibility level of the database is at 1701 or above.</remarks>
	[TypeConverter(typeof(DynamicPropertyConverter))]
	public sealed partial class TimeUnitColumnAssociation: CalendarColumnGroup
	{
	    internal new TOM.TimeUnitColumnAssociation MetadataObject 
		{ 
			get 
			{ 
				return base.MetadataObject as TOM.TimeUnitColumnAssociation; 
		    } 
			set 
			{ 
				base.MetadataObject = value; 
...
///             </summary>
		...
		[Category("Basic"),Description(@"The TimeUnit used in the association."),IntelliSense(@"The TimeUnit used in the association.")][TypeConverter(typeof(EnumBrowsableConverter))]
		public TimeUnit TimeUnit {
			get {
			    return (TimeUnit)MetadataObject.TimeUnit;
			}
			set {
				
				var oldValue = TimeUnit;
				var newValue = value;
				if (oldValue == newValue) return;
				bool undoable = true;
				bool cancel = false;
				OnPropertyChanging(Properties.TIMEUNIT, newValue, ref undoable, ref cancel);
				if (cancel) return;
				if (!MetadataObject.IsRemoved) MetadataObject.TimeUnit = (TOM.TimeUnit)newValue;
				if(undoable) Handler.UndoManager.Add(new UndoPropertyChangedAction(this, Properties.TIMEUNIT, oldValue, newValue));
				OnPropertyChanged(Properties.TIMEUNIT, oldValue, newValue);
			}
		}
		private bool ShouldSerializeTimeUnit() { return false; }
/// <summary>
...
///             </summary><value>The <see cref="T:TabularEditor.TOMWrapper.Column" /> instance that is the primary column, or a null reference (Nothing in Visual Basic) if such column is not set.</value>
		...
		public Column PrimaryColumn {
			get {
			    ...
			    return Handler.WrapperLookup[MetadataObject.PrimaryColumn] as Column;
            }
			set {
				
				var oldValue = PrimaryColumn;
				var newValue = value;
				if (oldValue?.MetadataObject == newValue?.MetadataObject) return;
				bool undoable = true;
				bool cancel = false;
				OnPropertyChanging(Properties.PRIMARYCOLUMN, newValue, ref undoable, ref cancel);
				if (cancel) return;
				if (!MetadataObject.IsRemoved) MetadataObject.PrimaryColumn = value == null ? null : Calendar.Table.Columns[value.MetadataObject.Name].MetadataObject;
				if(undoable) Handler.UndoManager.Add(new UndoPropertyChangedAction(this, Properties.PRIMARYCOLUMN, oldValue, newValue));
				OnPropertyChanged(Properties.PRIMARYCOLUMN, oldValue, newValue);
			}
		}
		private bool ShouldSerializePrimaryColumn() { return false; }
		// Skipping property AssociatedColumns on object TimeUnitColumnAssociation

		internal static TimeUnitColumnAssociation CreateFromMetadata(Calendar parent, TOM.TimeUnitColumnAssociation metadataObject) {
        ...
        internal override void RenewMetadataObject()
        {
            Handler.WrapperLookup.Remove(MetadataObject);
            var json = TOM.JsonSerializer.SerializeObject(MetadataObject, RenewMetadataOptions, Handler.CompatibilityLevel, Handler.Database.CompatibilityMode);
            MetadataObject = TOM.JsonSerializer.DeserializeObject<TOM.TimeUnitColumnAssociation>(json);
            Handler.WrapperLookup.Add(MetadataObject, this);
        }

		///<summary>The parent Calendar of the current Time Unit Column Association.</summary>
		public new Calendar Parent { 
			get {
				return Handler.WrapperLookup[MetadataObject.Parent] as Calendar;
			}
		}
		...
		/// CTOR - only called from static factory methods on the class
		/// </summary>
		TimeUnitColumnAssociation(TOM.TimeUnitColumnAssociation metadataObject) : base(metadataObject)
		{
		}
...
/// </summary><remarks>This metadata object is only supported when the compatibility level of the database is at 1701 or above.</remarks>
	[TypeConverter(typeof(DynamicPropertyConverter))]
	public sealed partial class TimeRelatedColumnGroup: CalendarColumnGroup
	{
	    internal new TOM.TimeRelatedColumnGroup MetadataObject 
		{ 
			get 
			{ 
				return base.MetadataObject as TOM.TimeRelatedColumnGroup; 
		    } 
			set 
			{ 
				base.MetadataObject = value; 
		...
		// Skipping property Columns on object TimeRelatedColumnGroup

		internal static TimeRelatedColumnGroup CreateFromMetadata(Calendar parent, TOM.TimeRelatedColumnGroup metadataObject) {
        ...
        internal override void RenewMetadataObject()
        {
            Handler.WrapperLookup.Remove(MetadataObject);
            var json = TOM.JsonSerializer.SerializeObject(MetadataObject, RenewMetadataOptions, Handler.CompatibilityLevel, Handler.Database.CompatibilityMode);
            MetadataObject = TOM.JsonSerializer.DeserializeObject<TOM.TimeRelatedColumnGroup>(json);
            Handler.WrapperLookup.Add(MetadataObject, this);
        }

		///<summary>The parent Calendar of the current Time Related Column Group.</summary>
		public new Calendar Parent { 
			get {
				return Handler.WrapperLookup[MetadataObject.Parent] as Calendar;
			}
		...
		/// CTOR - only called from static factory methods on the class
		/// </summary>
		TimeRelatedColumnGroup(TOM.TimeRelatedColumnGroup metadataObject) : base(metadataObject)
		{
		}
...
///             </summary><remarks>This property is only supported when the compatibility level of the database is at 1572 or above.</remarks>
        ...
        internal override ITabularObjectCollection GetCollectionForChild(TabularObject child)
        {
			...
			if (child is Calendar) return Calendars;
            return base.GetCollectionForChild(child);
        }
        ...
        /// <summary>
        /// The collection of Calendar objects on this Table.
        /// </summary>
		[DisplayName("Calendars")]
		[Category("Options"),IntelliSense("The collection of Calendar objects on the current Table.")][NoMultiselect(),Editor(typeof(CalendarCollectionEditor),typeof(UITypeEditor))]
		public CalendarCollection Calendars { get; protected set; }
		...
		protected Table(TOM.Table metadataObject) : base(metadataObject)
		{
			...
			Calendars = new CalendarCollection(this.GetObjectPath() + ".Calendars", MetadataObject.Calendars, this);
			...
			Calendars.CreateChildrenFromMetadata();
			...
			Calendars.CollectionChanged += Children_CollectionChanged;
		}
...
/// </summary><remarks>This metadata object is only supported when the compatibility level of the database is at 1701 or above.</remarks>
	[TypeConverter(typeof(DynamicPropertyConverter))]
	public sealed partial class Calendar: TabularNamedObject
			, ITabularTableObject
			, IDescriptionObject
			, ILineageTagObject
			, IClonableObject
	{
	    internal new TOM.Calendar MetadataObject 
		{ 
			get 
			{ 
				return base.MetadataObject as TOM.Calendar; 
		    } 
			set 
			{ 
				base.MetadataObject = value; 
		...
		// Skipping property CalendarColumnGroups on object Calendar
/// <summary>
...
///             </summary>
		[DisplayName("Description")]
		[Category("Basic"),Description(@"The description of the Calendar, visible to developers at design time and to administrators in management tools, such as SQL Server Management Studio."),IntelliSense(@"The description of the Calendar, visible to developers at design time and to administrators in management tools, such as SQL Server Management Studio.")][Editor(typeof(System.ComponentModel.Design.MultilineStringEditor), typeof(System.Drawing.Design.UITypeEditor))]
		public string Description {
			get {
			    return MetadataObject.Description;
			}
...
///             </summary>
		...
		private bool ShouldSerializeSourceLineageTag() { return false; }
		///<summary>The parent table of the current Calendar.</summary>
		[Browsable(false)]
		public Table Table
		{ 
			get 
		...
		internal static Calendar CreateFromMetadata(Table parent, TOM.Calendar metadataObject) {
            // Generate a new LineageTag if an object with the provided lineage tag already exists:
            if(!string.IsNullOrEmpty(metadataObject.LineageTag)) {
                if (parent.Handler.CompatibilityLevel < 1540) metadataObject.LineageTag = null;
                else if (parent.MetadataObject.Calendars.FindByLineageTag(metadataObject.LineageTag) != metadataObject) {
                    metadataObject.LineageTag = Guid.NewGuid().ToString();
                }
            }
			var obj = new Calendar(metadataObject);
			parent.Calendars.Add(obj);
		...
		/// <summary>
		/// Creates a new Calendar and adds it to the parent Table.
		/// Also creates the underlying metadataobject and adds it to the TOM tree.
		/// </summary>
		public static Calendar CreateNew(Table parent, string name = null)
		{
			if(!parent.Handler.PowerBIGovernance.AllowCreate(typeof(Calendar))) {
				throw new InvalidOperationException(string.Format(Messages.CannotCreatePowerBIObject,typeof(Calendar).GetTypeName()));
			}
        ...
        static partial void InitMetadata(TOM.Calendar metadataObject, Table parent);


		/// <summary>
		/// Creates an exact copy of this Calendar object.
		/// </summary>
		[IntelliSense("Creates an exact copy of this Calendar object.")]
		public Calendar Clone(string newName = null, Table newParent = null) {
			if(!Handler.PowerBIGovernance.AllowCreate(this.GetType())) {
				throw new InvalidOperationException(string.Format(Messages.CannotCreatePowerBIObject,typeof(Calendar).GetTypeName()));
			}

		    Handler.BeginUpdate("Clone Calendar");

			// Create a clone of the underlying metadataobject:
			var tom = MetadataObject.Clone() as TOM.Calendar;
        ...
        internal override void RenewMetadataObject()
        {
            Handler.WrapperLookup.Remove(MetadataObject);
            var json = TOM.JsonSerializer.SerializeObject(MetadataObject, RenewMetadataOptions, Handler.CompatibilityLevel, Handler.Database.CompatibilityMode);
            MetadataObject = TOM.JsonSerializer.DeserializeObject<TOM.Calendar>(json);
            Handler.WrapperLookup.Add(MetadataObject, this);
        }
        ...
        internal override ITabularObjectCollection GetCollectionForChild(TabularObject child)
        {
			if (child is CalendarColumnGroup) return CalendarColumnGroups;
            return base.GetCollectionForChild(child);
        }
        ...
        /// </summary>
		[DisplayName("Calendar Column Groups")]
		[Category("Basic"),IntelliSense("The collection of Calendar Column Group objects on the current Calendar.")][NoMultiselect(),Editor(typeof(CalendarColumnGroupCollectionEditor),typeof(UITypeEditor))]
		public CalendarColumnGroupCollection CalendarColumnGroups { get; private set; }

		/// <summary>
		/// CTOR - only called from static factory methods on the class
		/// </summary>
		Calendar(TOM.Calendar metadataObject) : base(metadataObject)
		{
			
			// Instantiate child collections:
			CalendarColumnGroups = new CalendarColumnGroupCollection(this.GetObjectPath() + ".CalendarColumnGroups", MetadataObject.CalendarColumnGroups, this);

			// Populate child collections:
			CalendarColumnGroups.CreateChildrenFromMetadata();

			// Hook up event handlers on child collections:
			CalendarColumnGroups.CollectionChanged += Children_CollectionChanged;
		}


		internal override void Reinit() {
			CalendarColumnGroups.Reinit();
		}
	...
	public sealed partial class CalendarCollection: TabularNamedObjectCollection<Calendar>
	{
		...
		internal CalendarCollection(string collectionName, TOM.CalendarCollection metadataObjectCollection, Table parent) : base(collectionName, parent)
		{
			TOM_Collection = metadataObjectCollection;
		}
		internal override Type GetItemType() { return typeof(Calendar); }
        internal override void TOM_Add(TOM.MetadataObject obj) { TOM_Collection.Add(obj as TOM.Calendar); }
        internal override bool TOM_Contains(TOM.MetadataObject obj) { return TOM_Collection.Contains(obj as TOM.Calendar); }
        internal override void TOM_Remove(TOM.MetadataObject obj) { TOM_Collection.Remove(obj as TOM.Calendar); }
        internal override void TOM_Clear() { TOM_Collection.Clear(); }
		internal override TOM.MetadataObject TOM_Get(int index) { return TOM_Collection[index]; }
        internal override bool TOM_ContainsName(string name) { return TOM_Collection.ContainsName(name); }
        internal override TOM.MetadataObject TOM_Get(string name) { return TOM_Collection[name]; }
        internal override TOM.MetadataObject TOM_Find(string name) { return TOM_Collection.Find(name); }
        internal override int IndexOf(TOM.MetadataObject obj) { return TOM_Collection.IndexOf(obj as TOM.Calendar); }
        /// <summary>The number of items in this collection.</summary>
		public override int Count { get { return TOM_Collection.Count; } }
		/// <summary>Returns an enumerator that iterates through the collection.</summary>
        public override IEnumerator<Calendar> GetEnumerator() { return TOM_Collection.Select(h => Handler.WrapperLookup[h]).OfType<Calendar>().GetEnumerator(); }
		internal override void Reinit() {
			var ixOffset = 0;
			for(int i = 0; i < Count; i++) {
				var metadataObj = TOM_Get(i) as TOM.Calendar;
				var item = Handler.WrapperLookup.TryGetValue(metadataObj, out var existingItem) ? existingItem as Calendar : CreateFromMetadata(metadataObj);
				Handler.WrapperLookup.Remove(item.MetadataObject);
				item.MetadataObject = Table.MetadataObject.Calendars[i + ixOffset] as TOM.Calendar;
				Handler.WrapperLookup.Add(item.MetadataObject, item);
				item.Collection = this;
			}
			TOM_Collection = Table.MetadataObject.Calendars;
			foreach(var item in this) item.Reinit();
		}
		...
		private Calendar CreateFromMetadata(TOM.Calendar obj)
		{
			if(obj is TOM.Calendar calendarObj) return Calendar.CreateFromMetadata(Table, calendarObj);
            else throw new ArgumentException("Cannot create object", "obj");
		}

		/// <summary>
		/// Calling this method will populate the CalendarCollection with objects based on the MetadataObjects in the corresponding MetadataObjectCollection.
		/// </summary>
		internal override void CreateChildrenFromMetadata()
		{
			// Construct child objects (they are automatically added to the Handler's WrapperLookup dictionary):
