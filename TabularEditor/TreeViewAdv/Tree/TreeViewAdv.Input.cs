	...
	public partial class TreeViewAdv
	{
		...
		protected override void OnMouseMove(MouseEventArgs e)
		{
			...
			if (ItemDragMode && Dist(e.Location, ItemDragStart) > ItemDragSensivity
				&& CurrentNode != null /*&& CurrentNode.IsSelected*/) // Commented out by DO@kapacity.dk - to allow dragging of unselected nodes
			{
				ItemDragMode = false;
		...
		private void CreateDragBitmap(IDataObject data)
		{
			...
			TreeNodeAdv[] nodes = data.GetData("Aga.Controls.Tree.TreeNodeAdv[]") as TreeNodeAdv[];
