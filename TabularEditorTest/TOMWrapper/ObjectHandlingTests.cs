...
namespace TabularEditor.TOMWrapper
{
    ...
    public class ObjectHandlingTests
    {
        ...
        public void CreateTestModel(string fileName)
        {
            ...
            var ds = tm.Model.AddDataSource("Test Datasource").ConnectionString = "Provider=SQLNCLI11;Data Source=localhost;Integrated Security=SSPI;Persist Security Info=false;Initial Catalog=AdventureWorksDW2012";
